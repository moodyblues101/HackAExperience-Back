...
const { findExperiencesByCategoryId } = require("../../repositories/experiences-repository");
...
async function getExperiencesByCategoryId(req, res) {
    try {
        ...
        if (experiences.length === 0) {
            throwJsonError(404, `No existen experiencias que pertenezcan a la categoria con id ${categoryId}`);
        }
