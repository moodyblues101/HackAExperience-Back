...
router.route('/:experienceId/image').all(validateAuth).post(uploadExperienceImageById);
router.route('/:experienceId/images').all(validateAuth).post(uploadMultipleExperienceImages);
