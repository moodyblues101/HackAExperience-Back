...
idCategory,
idBusiness)
VALUES (1,'Yoga en Adormideras','¡Yoga en la playa de Adormideras! Ven a disfrutar de una relajante experiencia acompañada de nuestros instructores más experimentados y regálate un momento de paz en tu día a día.', 'A Coruña', 25, 10, 10, 0, '2021-12-30 11:52:00', 1, 1),
(2, 'Relax para 2', 'Aprovecha esta oportunidad para escapar de las prisas del día a día y recibir un merecido masaje relajante para ti y para quien tú quieras.', 'Santiago', 30, 10, 10, 0, '2021-12-30 11:50:02', 1, 2),
(3, 'Taller de cocina italiana','¡Taller de cocina italiana en La Quadriglia! Si no tienes ni idea de cocinar pero te apetece a venir a pasar un buen rato y descubrir los secretos de la cocina italiana, vén a descubrir el mundo de la gastronomía de la mano de nuestros chefs.', 'A Coruña', 60, 10, 10, 0, '2021-12-30 11:50:04', 2, 3),
(4, 'Taller de nutrición',' Aprende de la mano de nuestros nutricionistas las claves de una alimentación saludable así como la forma de cocinar platos ricos y sanos.', 'Vigo', 15, 10, 10, 0, '2021-12-30 11:50:06', 2, 4),
(5, 'Conduce un Ferrari','¡Vén a vivir la experiencia de conducir un Ferrari! A lo largo de una tarde podrás disfrutar de la experiencia de conducir un Ferrari en circuito cerrado ', 'Barcelona', 60, 10, 10, 0, '2021-12-30 11:50:08', 3, 5),
(6, 'Viaje en yate', '¿Has pensado dónde vas a ir en tus próximas vacaciones? Este es tu momento: alquila un yate con tripulación propia y navega por el Mediterráneo a bordo de una magnífica embarcación y no te preocupes de nada más.', 'Vigo', 75, 10, 10, 0, '2021-12-30 11:50:10', 3, 6),
(7, 'Senderismo en Fraguas del Eume', 'Vén a disfrutar de una de las rutas más bonitas por la naturaleza adaptada a todos los públicos ', 'A Coruña', 35, 10, 10, 0, '2021-12-30 11:50:12', 4, 7),
(8, 'Kayak Fragas do Eume ','Actividad de aventura en kayak en el corazón de As Fragas do Eume. Conoce el bosque atlántico mejor conservado de Europa desde su interior de una manera única', 'A Coruña', 55, 10, 10, 0, '2021-12-30 11:50:14', 4, 8),
(9, 'Sesión de entrenamiento personal', 'Vive una experiencia deportiva diferente con un entrenador personal a tu disposición para guiarte en los ejercicios que más se adecuen a tu rutina', 'Madrid', 25, 10, 10, 0, '2021-12-30 11:52:00', 1, 1),
(10, 'Cena especial','Indícanos tus gustos culinarios y musicales y te preparemos una cena inolvidable.', 'Santiago', 30, 10, 10, 0, '2021-12-30 11:50:02', 1, 2),
(11, 'Taller de comida thailandesa', 'En nuestro taller de cocina tailandesa, aprendemos a preparar y a disfrutar de los platos más representativos de la gastronomía de este país. Atrévete a experimentar nuevos sabores.', 'A Coruña', 60, 10, 10, 0, '2021-12-30 11:50:04', 2, 3),
(12, 'Fotografía de producto','Si quieres tener un perfil que sea la envidia de todos tus amigo, aprender a resaltar productos y hacer composicioness este es tu sitio.', 'Vigo', 15, 10, 10, 0, '2021-12-30 11:50:06', 2, 4),
(13, 'Pilota un helicóptero', '¡Pilotar un helicóptero real es una experiencia única que se debe vivir al menos una vez en la vida! Un instructor te acompañará a lo largo de todo el vuelo para que puedas sentir la seguridad de estar en buenas manos y la emoción de pilotar el helicóptero.', 'Barcelona', 60, 10, 10, 0, '2021-12-30 11:50:08', 3, 5),
(14, 'Pilota una moto de carreras ','Siéntete un auténtico piloto de carreras, conduciendo por nuestro circuito cerrado.¡Disfruta de una buena ración de adrenalina y velocidad sobre una motocicleta!', 'Zaragoza', 75, 10, 10, 0, '2021-12-30 11:50:10', 3, 6),
(15, 'Viaje en globo','Vive con nosotros la experiencia mágina e inolvidable de surcar los cielos.', 'Valencia', 35, 10, 10, 0, '2021-12-30 11:50:12', 4, 7),
(16, 'Rafting en el Ulla','Con la ayuda de un monitor-guía nuestros aventureros tendrán como misión experimentar las mejores sensaciones de bajar un río de aguas bravas.', 'A Coruña', 55, 10, 10, 0, '2021-12-30 11:50:14', 4, 8)
;
