...
const { findExperiencesByBusinessId } = require("../../repositories/experiences-repository");
...
async function getExperiencesByBusinessId(req, res) {
    try {
        ...
        if (experiences.length === 0) {
            throwJsonError(404, `No existen experiencias que pertenezcan a la categoria con id ${businessId}`);
        }
